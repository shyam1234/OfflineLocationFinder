...
public class MapLogAdapter extends RecyclerView.Adapter<MapLogAdapter.MyViewHolder> {
    private final Context mContext;
    private final ArrayList<MapLogDataModel> mList;
    private View.OnClickListener mListener;

    public MapLogAdapter(Context pContext, ArrayList<MapLogDataModel> pList) {
        mContext = pContext;
        mList = pList;
    ...
    @Override
    public MapLogAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(MapLogAdapter.MyViewHolder holder, int position) {
